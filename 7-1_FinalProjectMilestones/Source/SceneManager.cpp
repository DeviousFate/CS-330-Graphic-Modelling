...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/stonefloor.jpg",
		"Floor");
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/Power.jpg",
		"Power");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/Fan.jpg",
		"Fan");
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/MBoard.jpg",
		"MBoard");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/Radiator.jpg",
		"Radiator");
...
void SceneManager::DefineObjectMaterials()
{
	...
	std::cout << "Metal material loaded." << std::endl;
	...
	std::cout << "cement material loaded." << std::endl;*/
	...
	std::cout << "wood material loaded." << std::endl;

	OBJECT_MATERIAL waterMaterial;
	waterMaterial.ambientColor = glm::vec3(0.2f, 0.3f, 0.4f);
	waterMaterial.ambientStrength = 0.3f;
	waterMaterial.diffuseColor = glm::vec3(0.3f, 0.2f, 0.1f);
	waterMaterial.specularColor = glm::vec3(0.4f, 0.5f, 0.6f);
	waterMaterial.shininess = 25.0;
	waterMaterial.tag = "water";
	m_objectMaterials.push_back(waterMaterial);
	std::cout << "water material loaded." << std::endl;
	...
	std::cout << "glass material loaded." << std::endl;
	...
	std::cout << "clay material loaded." << std::endl;
}
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 15.0f, 3.0f); // Above the center of the scene
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.3f, 0.3f, 0.3f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.8f, 0.8f, 0.8f); // Soft white light
	...
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", 0.6f, 0.6f, 0.6f); // Back fill light
	...
	std::cout << "light 3 loaded.";

	m_pShaderManager->setVec3Value("lightSources[3].position", 0.0f, -10.0f, 0.0f); // Under the scene
	...
	m_pShaderManager->setFloatValue("lightSources[3].linear", 0.1f);
	m_pShaderManager->setFloatValue("lightSources[3].quadratic", 0.05f);
...
void SceneManager::RenderScene()
{
	...
	// Mesh for Computer Case :: Box :: Hang Wall ------------------------------------
	
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(9.0f, 7.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.75f, 3.0f, -2.9f);
	...
	// Mesh for Computer Case :: Box :: Front Wall ------------------------------------

	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 7.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.4f, 3.0f, 1.0f);
	...
	SetTransformations(
		...
		positionXYZ);
	// green
	//SetShaderColor(.3, 1, .3, 1);
	SetShaderTexture("Wall");
	SetShaderMaterial("Metal");

	// Mesh for Computer Case :: Box :: Rear Wall ------------------------------------
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 3.0f, -3.15f);
	...
	// Mesh for Computer Case :: Box :: Floor Wall ------------------------------------

// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh();

	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(9.0f, 4.0f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.6f, 0.0f, -0.9f);
	...
	// Mesh for Computer Case :: Box :: Roof Wall ------------------------------------
...
// draw the mesh with transformation values
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.6f, 6.5f, -0.9f);
	...
	// Meshes for Water Reservoir :: Two Cylinders and a Torus to represent O-Ring ------------------------------------

	// Main Tank ------------------------------------------------------------------------------------------------------
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.75f, 2.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.99f, 3.0f, -0.33f);
	...
	// set the color values into the shader
	// SetShaderColor(0.675, 0.792, 0.831, 1);
	...
	// Tank Lid ------------------------------------------------------------------------------------------------------
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.75f, 0.5f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.99f, 4.8f, -0.33f);
	...
	// O-Ring separating lid from tank --------------------------------------------------------------------------------
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3( 0.75f, 1.0f, 0.15f);
	...
	// Boxes Representing Fans --------------------------------------------------------------------------------
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.66f, 1.0f, -0.67f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.99f, 1.0f, 0.67f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.99f, 1.0f, -2.33f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.67f, 4.0f, -1.99f);
